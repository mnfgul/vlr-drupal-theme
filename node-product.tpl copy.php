	...
	<table>
		<tr>
			<td width="200">
				...
				<p>
					<label for="edit-attributes-1-1" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-1-1" name="attributes[File Type (Front)][1]"> GIF</label>	
				...
				<p>
					<label for="edit-attributes-1-2" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-1-2" name="attributes[File Type (Front)][2]"> JPG</label>
				...
				<p>
					<label for="edit-attributes-1-3" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-1-3" name="attributes[File Type (Front)][3]"> EPS MAC</label>
				...
				<p>
					<label for="edit-attributes-1-4" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-1-4" name="attributes[File Type (Front)][4]"> EPS PC</label>
				...
				<p>
					<label for="edit-attributes-1-5" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-1-5" name="attributes[File Type (Front)][5]"> RGB TGA</label>
			...
			<td width="200">
				...
				<p>
					<label for="edit-attributes-2-6" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-2-6" name="attributes[File Type (Back)][6]"> GIF</label>
				...
				<p>
					<label for="edit-attributes-2-7" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-2-7" name="attributes[File Type (Back)][7]"> JPG</label>
				...
				<p>
					<label for="edit-attributes-2-8" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-2-8" name="attributes[File Type (Back)][8]"> EPS MAC</label>
				...
				<p>
					<label for="edit-attributes-2-9" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-2-9" name="attributes[File Type (Back)][9]"> EPS PC</label>
				...
				<p>
					<label for="edit-attributes-2-10" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-2-10" name="attributes[File Type (Back)][10]"> RGB TGA</label>
			...
			<td width="200">
				...
				<p>
					<label for="edit-attributes-3-11" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-3-11" name="attributes[File Type (Data)][11]"> TXT</label>
				...
				<p>
					<label for="edit-attributes-3-12" class="option"><input type="checkbox" class="form-checkbox" value="1" id="edit-attributes-3-12" name="attributes[File Type (Data)][12]"> DOC</label>
